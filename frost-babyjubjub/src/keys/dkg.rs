...
pub mod round1 {
    ...
    pub type SecretPackage = frost::keys::dkg::round1::SecretPackage<BabyJubjubSha256>;

    /// The package that must be broadcast by each participant to all other participants
    /// between the first and second parts of the DKG protocol (round 1).
    pub type Package = frost::keys::dkg::round1::Package<BabyJubjubSha256>;
}
...
pub mod round2 {
    ...
    ///
    /// This package MUST NOT be sent to other participants!
    pub type SecretPackage = frost::keys::dkg::round2::SecretPackage<BabyJubjubSha256>;
    ...
    pub type Package = frost::keys::dkg::round2::Package<BabyJubjubSha256>;
}
...
pub fn part2(
    ...
    round1_packages: &BTreeMap<Identifier256, round1::Package>,
) -> Result<
    (
        round2::SecretPackage,
        BTreeMap<Identifier256, round2::Package>,
    ),
    Error,
> {
...
pub fn part3(
    ...
    round1_packages: &BTreeMap<Identifier256, round1::Package>,
    round2_packages: &BTreeMap<Identifier256, round2::Package>,
