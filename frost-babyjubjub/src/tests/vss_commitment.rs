...
fn check_serialize_vss_commitment() {
    ...
    frost_core::tests::vss_commitment::check_serialize_vss_commitment::<BabyJubjubSha512, _>(rng);
}

#[test]
fn check_serialize_whole_vss_commitment() {
    let rng = rand::rngs::OsRng;
    frost_core::tests::vss_commitment::check_serialize_whole_vss_commitment::<BabyJubjubSha512, _>(
        rng,
    );
}
...
fn check_deserialize_vss_commitment() {
    let rng = rand::rngs::OsRng;
    frost_core::tests::vss_commitment::check_deserialize_vss_commitment::<BabyJubjubSha512, _>(rng);
}

#[test]
fn check_deserialize_whole_vss_commitment() {
    let rng = rand::rngs::OsRng;
    frost_core::tests::vss_commitment::check_deserialize_whole_vss_commitment::<BabyJubjubSha512, _>(
        rng,
    );
}
...
fn check_deserialize_vss_commitment_error() {
    let rng = rand::rngs::OsRng;
    frost_core::tests::vss_commitment::check_deserialize_vss_commitment_error::<BabyJubjubSha512, _>(
        rng, &ELEMENTS,
    );
}
...
fn check_compute_public_key_package() {
    let rng = rand::rngs::OsRng;
    frost_core::tests::vss_commitment::check_compute_public_key_package::<BabyJubjubSha512, _>(rng);
}
